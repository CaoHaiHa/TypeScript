...
// console.log(countriesSortName(countries_data))
// console.log(countriesSortCapital(countries_data))
// console.log(countriesSortPopulation(countries_data))
// console.log('-----------------------------------------------------------')
...
// console.log(mostSpokenLanguages(countriesLanguages, 10))
// console.log(mostSpokenLanguages(countriesLanguages, 3))
// console.log('-----------------------------------------------------------')
...
// console.log(mostPopulationCountries(mostPopulationCountriesArray, 10))
