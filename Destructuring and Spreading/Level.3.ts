...
// const student: Student = ['David', ['HTM', 'CSS', 'JS', 'React'], [98, 85, 90, 95]]
...
//     let { name, capital, population, languages }: Country = countries_data[i]
//     console.log(name, capital, population, languages)
// }
// console.log(`-------------------------------------------------------`)

// //Cau 2:
// let [n, skills, [, , jsScore, reactScore]]: Student = student

// console.log(n, skills, jsScore, reactScore)
// console.log(`-------------------------------------------------------`)

// //Cau 3:
// const convertArrayToObject = (arr: any[]): object[] => {
//     for (let i in arr) {
//         let [n, sk, sc]: Student = arr[i]
//         arr[i] = {
//             name: n,
//             skills: sk,
//             scores: sc
