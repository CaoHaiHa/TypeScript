...
//     for (let j in countries_data[i].languages) languagesSet.add(countries_data[i].languages[j])
// }
...
// for (let i in countries_data) {
//     for (let j in countries_data[i].languages) languages.push(countries_data[i].languages[j])
// }

// console.log(languages)

// const mostSpokenLanguages = (countries: Set<string>, num: number) => {
//     let newArr: { lang: string, count: number }[] = []
//     let newArr2: string[] = []
//     for (let i of countries) {
//         const temp = languages.filter((e: string) => e === i)
//         newArr.push({ lang: i, count: temp.length })
//     }
//     newArr = newArr.sort((e1: { lang: string, count: number }, e2: { lang: string, count: number }) => {
//         if (e1.count > e2.count) return -1
//         else return 0
//     })
//     for (let i: number = 0; i < num; i++) {
//         let test: string = `${newArr[i].lang}: ${newArr[i].count}`
//         newArr2.push(test)
//     }
//     return newArr2
// }

// console.log(mostSpokenLanguages(languagesSet, 10))
// console.log(mostSpokenLanguages(languagesSet, 3))